...
const Information = ({ data }) => {
  ...
  return (
    ...
    <Box className={classes.component}>
      ...
      <Typography className={classes.row}><OpacityIcon className={classes.icon}/>Humididty  <Box className={classes.value} component="span">{data.main.humidity}%</Box></Typography>
      <Typography className={classes.row}><CompareArrowsIcon className={classes.icon} />Pressure  <Box className={classes.value} component="span">{data.main.pressure}"</Box></Typography>
